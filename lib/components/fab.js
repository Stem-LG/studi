...
import { MdOutlineTranslate, MdClose, MdArrowBack } from "react-icons/md";
...
function BackButton(){
    ...
    return <Box
            sx={{ position: "fixed", bottom: 16, left: 16, gap: 1, display:router.pathname == "/"?"none":"block"}}
        >
            <Fab
                color="primary"
                size="large"
...
export {FloatingButton, BackButton}